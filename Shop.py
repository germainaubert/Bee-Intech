...
class shop():
	...
	def __init__(self):
		...
		self._bees = [worker_bee('hervé2', 5, 'worker', [10,"whater"], 1, "./Images/bak.jpg", 15, "whater", None),
		worker_bee('hervé3', 10, 'worker', [10,"whater"], 1, "./Images/merveille.jpg",  20 , "whater", None),
		worker_bee('stonks', 20, 'worker', [10,"whater"], 1, "./Images/stonks.jpeg",  10000 , "whater", None),
