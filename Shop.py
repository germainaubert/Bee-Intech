...
class shop():
	...
	def __init__(self):
		...
		self._bees = [worker_bee('Abeille basique', 5, 'worker', [10,"honey"], 1, "./Images/bees/basic_bee.png", 2, "honey", None),
		worker_bee('Abeille basique', 10, 'worker', [10,"honey"], 1, "./Images/bees/basic_bee.png", 20, "honey", None),
